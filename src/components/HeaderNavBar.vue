    ...
    <ul class="nav">
      ...
      <div v-if="userInfo" style="display: inline-block">
        ...
        >
         ...
         <li style="position: absolute; top:0px; right: 100px; color:white">
          {{ userInfo.realId }}님 환영합니다.
        </li>  
      </div>
      <div v-else>
